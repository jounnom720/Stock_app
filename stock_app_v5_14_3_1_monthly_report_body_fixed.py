...
APP_VERSION = "v5.14.3.1"  # 월간 리포트 본문 고도화 / html import 오류 수정 / 리포트 가독성 보완 / 실시간 시세 보정 유지
...
def 월간투자리포트초안UI(거래df=None, 계산포트폴리오=None, 보유포트폴리오=None, 통합자산표=None, 위험분석=None):
    ...
    with 우:
        st.caption("v5.14.3은 숫자표보다 문장형 해석을 강화한 단계입니다. 다음 단계에서 Word/PDF 다운로드로 확장할 수 있습니다.")
    ...
    st.download_button(
        ...
        mime="text/plain",
        key="download_monthly_report_text_v5143",
        use_container_width=True,
    )
    return 리포트
