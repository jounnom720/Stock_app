...
st.info("이 버전은 공유용입니다. 기존 개인 거래이력은 제거했고, 화면 확인을 위한 샘플 데이터만 포함되어 있습니다. 직접 사용하실 경우 사이드바에서 본인 거래이력 파일을 업로드하거나 거래를 직접 입력해 주세요.")
...
st.write("※ 주요 지수와 종목 차트는 pykrx 우선, 배포 환경에서는 Yahoo 대체 경로를 함께 사용하도록 구성했습니다.")
