# v5.6 정리 마감본 / 관심종목 추가 제거 / 주요지표 표기 유지 / 안정화본
import io
import base64
import json
import math
...
APP_VERSION = "v5.13.6-share"  # 공유용 Share 버전 / 샘플 엑셀 강제 초기 연결 / 중복 코멘트 개선 UI
SHARE_MODE = True

st.set_page_config(page_title=f"투자 분석 시스템 (공유용) {APP_VERSION}", layout="wide")


SHARE_SAMPLE_EXCEL_NAME = "통합자산관리_share.xlsx"
SHARE_SAMPLE_EXCEL_B64 = """
UEsDBBQABgAIAAAAIQCG2vR3hgEAAJQGAAATAAgCW0NvbnRlbnRfVHlwZXNdLnhtbCCiBAIooAACAAAAAAAAAAAAAAAAAAAAAAAA
...

"""
...
def 공유샘플엑셀바이트():
    try:
        return base64.b64decode("".join(str(SHARE_SAMPLE_EXCEL_B64).split()))
    except Exception:
        return b""
...
def 공유샘플거래이력불러오기():
    try:
        원본바이트 = 공유샘플엑셀바이트()
        읽기df = pd.read_excel(io.BytesIO(원본바이트), sheet_name="거래이력", dtype=object)
...
if 모바일여부():
    st.title(f"📈 투자 분석 시스템 (공유용) {APP_VERSION}")
    st.caption("모바일 조회용 간소화 화면 · 샘플 통합자산관리 데이터 내장")
else:
    st.title(f"📈 투자 분석 시스템 (공유용) {APP_VERSION}")
    st.caption("공유용 Share 버전 · 개인정보 제거 · 샘플 거래이력 및 비주식자산 데이터 내장")
...
목표비중저장파일 = "target_weights_share.json"
거래이력자동저장파일 = "trade_history_autosave_share.json"
최근업로드거래이력파일 = "trade_history_latest_uploaded_share.json"
최근업로드메타파일 = "trade_history_latest_uploaded_meta_share.json"
모니터관심종목저장파일 = "monitor_custom_assets_share_v54.json"

IRP비주식자산저장파일 = "integrated_non_stock_assets_share_v513.json"
...
def IRP비주식자산불러오기():
    # Share 버전은 최초 1회 반드시 내장 샘플 엑셀의 비주식자산 시트를 기본값으로 연결합니다.
    # 이전 실행에서 남은 share JSON/session 데이터가 있어도, 새 버전 최초 실행 시 샘플 엑셀을 우선 반영합니다.
    if SHARE_MODE and not st.session_state.get("share_non_stock_sample_initialized_v5136", False):
        df = 공유샘플비주식자산불러오기()
        st.session_state["irp_non_stock_assets_df_v512"] = IRP비주식자산표준열맞추기(df)
        st.session_state["share_non_stock_sample_initialized_v5136"] = True
        return st.session_state["irp_non_stock_assets_df_v512"]

    if "irp_non_stock_assets_df_v512" in st.session_state:
        return IRP비주식자산표준열맞추기(st.session_state["irp_non_stock_assets_df_v512"])

    if (not SHARE_MODE) and os.path.exists(IRP비주식자산저장파일):
        try:
    ...
    df = 공유샘플비주식자산불러오기() if SHARE_MODE else 기본IRP비주식자산표()
    st.session_state["irp_non_stock_assets_df_v512"] = df
    return df
...
def 네이버국내현재가가져오기(구분, 코드):
    코드 = str(코드).zfill(6) if str(코드).isdigit() else str(코드)
    if 구분 == "index":
        url = "https://finance.naver.com/sise/sise_index.naver?code=KOSPI" if str(코드) == "1001" else "https://finance.naver.com/sise/sise_index.naver?code=KOSDAQ"
    else:
        url = f"https://finance.naver.com/item/main.naver?code={코드}"

    try:
        응답 = 안전웹요청(url, timeout=2.5, attempts=1)
        if 응답 is None:
            return None
        html = 응답.text
        ...
        if 구분 == "index":
            now_m = re.search(r'<em[^>]*id="now_value"[^>]*>([^<]+)</em>', html, re.I)
            rate_m = re.search(r'<span[^>]*id="change_value_and_rate"[^>]*>([^<]+)</span>', html, re.I)
            현재가 = 안전실수변환(now_m.group(1)) if now_m else None
            변화문구 = rate_m.group(1).strip() if rate_m else ""
            if 변화문구:
                nums = re.findall(r'[-+]?\d+[\d,]*\.?\d*', 변화문구)
                if nums:
                    전일대비 = 안전실수변환(nums[0])
                if len(nums) >= 2:
                    등락률 = 안전실수변환(nums[1])
                if ('하락' in 변화문구 or '▼' in 변화문구):
                    if 전일대비 not in [None, 0]:
                        전일대비 = -abs(float(전일대비))
                    if 등락률 not in [None, 0]:
                        등락률 = -abs(float(등락률))
                elif ('상승' in 변화문구 or '▲' in 변화문구):
                    if 전일대비 not in [None, 0]:
                        전일대비 = abs(float(전일대비))
                    if 등락률 not in [None, 0]:
                        등락률 = abs(float(등락률))
            ...
            for ptn in 패턴:
                ...
                if m:
                    ...
                    if 현재가 is not None:
                        break
            diff_m = re.search(r'<strong[^>]*id="_diff"[^>]*>([^<]+)</strong>', html, re.I | re.S)
            rate_m = re.search(r'<span[^>]*class="tah p11"[^>]*id="_rate"[^>]*>([^<]+)</span>', html, re.I | re.S)
            전일대비 = 안전실수변환(diff_m.group(1)) if diff_m else None
            등락률 = 안전실수변환(rate_m.group(1)) if rate_m else None
            blind_text = ' '.join(re.findall(r'<span[^>]*class="blind"[^>]*>([^<]+)</span>', html, re.I | re.S)[:20])
            if '하락' in blind_text:
                if 전일대비 not in [None, 0]:
                    전일대비 = -abs(float(전일대비))
                if 등락률 not in [None, 0]:
                    등락률 = -abs(float(등락률))
            elif '상승' in blind_text:
                if 전일대비 not in [None, 0]:
                    전일대비 = abs(float(전일대비))
                if 등락률 not in [None, 0]:
                    등락률 = abs(float(등락률))
...
def 실시간포함시세요약가져오기(구분, 코드, lookback_days=15, refresh_token=0):
    ...
    if 장중:
        # 지수는 Naver index 페이지 파싱 오작동 가능성이 있어 Yahoo 우선 사용
        if 구분 != "index":
            국내현재가 = 네이버국내현재가가져오기(구분, 코드)
            if 국내현재가 is not None and 국내현재가.get("현재가") not in [None, 0]:
                병합 = 시세요약안전병합(요약, 국내현재가)
                병합["비교기준"] = "전일 종가 대비"
                병합 = 비교값보강적용(병합, 구분, 코드)
                if 병합.get("전일대비") in [None] or 병합.get("등락률") in [None]:
                    병합["상태"] = "국내 현재가 반영(Naver, 전일비교 일부보강)"
                return 병합
...
def 자산현재가정보(자산명, 자산정보, refresh_token=0):
    ...
    if 스냅샷정보 and 스냅샷정보.get("현재가") not in [None, 0]:
        스냅샷정보["자산명"] = 자산명
        return 스냅샷정보
...
def 월간수익률리포트엑셀바이트(요약, 종목별, 월원장, 선택년월):
    ...
    with pd.ExcelWriter(버퍼, engine="openpyxl") as writer:
        ...
        월원장.to_excel(writer, index=False, sheet_name="월간거래")
    버퍼.seek(0)
    return 버퍼.getvalue()
...
def 현재거래이력가져오기():
    ...
    개인용은 최근 업로드/자동저장 우선, Share 버전은 최초 1회 내장 샘플 엑셀 우선입니다.
    """

    # Share 버전은 새 파일/새 버전 최초 실행 시 기존 세션·자동저장 잔여값보다
    # 방금 내장한 통합자산관리_share.xlsx의 거래이력 시트를 기본값으로 확실히 반영합니다.
    share_샘플초기화필요 = SHARE_MODE and not st.session_state.get("share_trade_sample_initialized_v5136", False)

    if ("trade_history_df_v22" not in st.session_state) or share_샘플초기화필요:
        if SHARE_MODE:
            초기df = 공유샘플거래이력불러오기()
            st.session_state["trade_history_source_v1"] = "share_sample_excel"
            st.session_state["trade_history_latest_upload_name_v1"] = SHARE_SAMPLE_EXCEL_NAME
            st.session_state["trade_history_latest_upload_time_v1"] = 서울현재시각ISO()
            st.session_state["share_trade_sample_initialized_v5136"] = True
        else:
            후보목록 = []
...
if 선택섹터 == "주요 모니터링":
    ...
    with 모니터헤더칸2:
        조회모드문구 = "실시간/준실시간 반영 · 비교 전일 종가 기준" if st.session_state.get("monitor_realtime_mode_v1", False) else "전일 종가 기준 표시"
...
with st.sidebar.expander("거래이력 관리", expanded=False):
    ...
    st.caption("공유용 기본 데이터는 내장된 샘플 통합자산관리 엑셀입니다. 필요 시 별도 파일도 업로드할 수 있습니다.")
...
st.markdown("---")
st.markdown('공유용 Share 버전 · 샘플 데이터 기반 · 개발자 조현웅 <a href="mailto:hwcho@me.com">hwcho@me.com</a>', unsafe_allow_html=True)
...
def 네이버시장지표목록가져오기():
    ...
    for 이름 in 표시순서:
        ...
        결과.append({
            ...
            "조회시각": 행.get("조회시각"),
            "기준시각": 행.get("기준시각"),
            "비교기준": 행.get("비교기준", "전일 종가 대비"),
            "지표구분": 행.get("지표구분", "준실시간"),
            "상태": 행.get("상태", ""),
        })
