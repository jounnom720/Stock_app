...
APP_VERSION = "v5.14 share"  # 공개용 Share 버전 / 샘플 거래이력·비주식자산 내장 / Word 리포트 다운로드 유지
...
st.set_page_config(page_title=f"투자분석시스템 {APP_VERSION}", layout="wide")
...
if 모바일여부():
    st.title(f"투자분석시스템 {APP_VERSION}")
    st.caption("모바일 조회용 간소화 화면 · 공개용 Share 버전")
else:
    st.title(f"투자분석시스템 {APP_VERSION}")

st.caption("공개용 Share 버전 · 개인 정보 제거 · 샘플 거래이력 및 통합자산 데이터 내장")
...
[{'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-03-05', '거래구분': '매수', '거래수량': 1000, '거래단가': 84936, '운용사': '신한은행 IRP', '비고': ''}, {'종목코드': '471990', '종목명': 'KODEX AI반도체핵심장비', '거래일자': '2026-03-27', '거래구분': '매수', '거래수량': 500, '거래단가': 24574, '운용사': '신한은행 IRP', '비고': ''}, {'종목코드': '005930', '종목명': '삼성전자', '거래일자': '2026-03-31', '거래구분': '매수', '거래수량': 500, '거래단가': 168200, '운용사': '미래에셋증권', '비고': ''}, {'종목코드': '000660', '종목명': 'SK하이닉스', '거래일자': '2026-03-31', '거래구분': '매수', '거래수량': 50, '거래단가': 811000, '운용사': '미래에셋증권', '비고': ''}, {'종목코드': '471990', '종목명': 'KODEX AI반도체핵심장비', '거래일자': '2026-04-02', '거래구분': '매수', '거래수량': 400, '거래단가': 24759, '운용사': '신한은행 IRP', '비고': ''}, {'종목코드': '005930', '종목명': '삼성전자', '거래일자': '2026-04-20', '거래구분': '매수', '거래수량': 100, '거래단가': 216000, '운용사': '미래에셋증권', '비고': ''}, {'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-04-24', '거래구분': '매수', '거래수량': 300, '거래단가': 98218, '운용사': '신한은행 IRP', '비고': ''}, {'종목코드': '471990', '종목명': 'KODEX AI반도체핵심장비', '거래일자': '2026-04-24', '거래구분': '매수', '거래수량': 500, '거래단가': 29169, '운용사': '신한은행 IRP', '비고': ''}, {'종목코드': '009150', '종목명': '삼성전기', '거래일자': '2026-04-29', '거래구분': '매수', '거래수량': 100, '거래단가': 820000, '운용사': '미래에셋증권', '비고': ''}, {'종목코드': '071970', '종목명': 'HD현대마린엔진', '거래일자': '2026-04-29', '거래구분': '매수', '거래수량': 500, '거래단가': 107500, '운용사': '미래에셋증권', '비고': ''}, {'종목코드': '034020', '종목명': '두산에너빌리티', '거래일자': '2026-04-29', '거래구분': '매수', '거래수량': 500, '거래단가': 127100, '운용사': '미래에셋증권', '비고': ''}, {'종목코드': '298040', '종목명': '효성중공업', '거래일자': '2026-04-29', '거래구분': '매수', '거래수량': 20, '거래단가': 3912000, '운용사': '미래에셋증권', '비고': ''}, {'종목코드': '005380', '종목명': '현대차', '거래일자': '2026-04-29', '거래구분': '매수', '거래수량': 50, '거래단가': 531000, '운용사': '미래에셋증권', '비고': ''}]
)
...
모니터관심종목저장파일 = "monitor_custom_assets_v54_share.json"

IRP비주식자산저장파일 = "integrated_non_stock_assets_v513_share.json"


def 기본IRP비주식자산표():
    return pd.DataFrame(
[{'계좌': '은행 IRP', '자산군': 'TDF', '상품명': 'TDF2035', '원금': 100000000, '평가금액': 120000000, '예상연수익률': 0.0, '만기일': '', '반영일자': '2026-04-30', '비고': ''}, {'계좌': '은행 IRP', '자산군': 'TDF', '상품명': 'TDF2045', '원금': 300000000, '평가금액': 320000000, '예상연수익률': 0.0, '만기일': '', '반영일자': '2026-04-30', '비고': ''}, {'계좌': '증권 IRP', '자산군': '정기예금', '상품명': '증권사 정기예금', '원금': 50000000, '평가금액': 50000000, '예상연수익률': 3.1, '만기일': '2027-02-11', '반영일자': '2026-04-30', '비고': ''}, {'계좌': '증권 IRP', '자산군': '현금성자산', '상품명': '현금성 대기자산', '원금': 150000000, '평가금액': 153000000, '예상연수익률': 2.3, '만기일': '', '반영일자': '2026-04-30', '비고': ''}, {'계좌': '증권사', '자산군': '현금성자산', '상품명': '예수금', '원금': 50000000, '평가금액': 50000000, '예상연수익률': 0.0, '만기일': '', '반영일자': '2026-04-30', '비고': ''}]
    )
