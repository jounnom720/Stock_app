...
APP_VERSION = "v5.13.4-mobile"  # 개인용 모바일 조회 최적화 버전
...
모바일모드 = st.query_params.get("desktop", "0") != "1"  # 모바일 버전 기본값: 모바일 화면
...
if 모바일여부():
    st.markdown(
        ...
        .main .block-container {padding-left: 0.8rem !important; padding-right: 0.8rem !important; max-width: 760px !important;}
        div[data-testid="stHorizontalBlock"] {gap: 0.55rem !important;}
        button[kind="primary"], button[kind="secondary"] {min-height: 42px !important; font-size: 0.92rem !important;}
        .top-monitor-title {font-size: 1.22rem !important;}
        </style>
        """,
        unsafe_allow_html=True,
    )
...
기본포트폴리오 = pd.DataFrame([{'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-03-05', '거래구분': '매수', '거래수량': 35, '거래단가': 84936, '운용사': '신한은행 IRP', '비고': '폭락 이후 반등'}, {'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-03-10', '거래구분': '매수', '거래수량': 59, '거래단가': 82900, '운용사': '신한은행 IRP', '비고': '트럼프 이란전 조기 종료 발표, 주요 국제 유가 하락'}, {'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-03-23', '거래구분': '매수', '거래수량': 23, '거래단가': 84031, '운용사': '신한은행 IRP', '비고': '코덱스 -6.5% 하락에 분할매수 유리 판단'}, {'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-03-24', '거래구분': '매수', '거래수량': 35, '거래단가': 83872, '운용사': '신한은행 IRP', '비고': '전일 폭락 후 오늘 트럼프의 이란 공격 중지 발표로 유가, 환율 하락'}, {'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-03-27', '거래구분': '매수', '거래수량': 63, '거래단가': 79227, '운용사': '신한은행 IRP', '비고': '하락 지속 중 상승 기대'}, {'종목코드': '471990', '종목명': 'KODEX AI반도체핵심장비', '거래일자': '2026-03-27', '거래구분': '매수', '거래수량': 122, '거래단가': 24574, '운용사': '신한은행 IRP', '비고': '반도체 종목 상승 기대'}, {'종목코드': '005930', '종목명': '삼성전자', '거래일자': '2026-03-31', '거래구분': '매수', '거래수량': 42, '거래단가': 168200, '운용사': '미래에셋증권', '비고': '자사주 매각 기사 호재로 판단, 금일 최저가 확인후 소폭 상승, 오전 장 초반 소심매도에 따른 후회'}, {'종목코드': '000660', '종목명': 'SK하이닉스', '거래일자': '2026-03-31', '거래구분': '매수', '거래수량': 2, '거래단가': 811000, '운용사': '미래에셋증권', '비고': '자사주 매각 기사 호재로 판단, 금일 최저가 확인후 소폭 상승, 오전 장 초반 소심매도에 따른 후회'}, {'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-04-01', '거래구분': '매수', '거래수량': 24, '거래단가': 80609, '운용사': '신한은행 IRP', '비고': '미국과 이란의 종전 준비 언급으로 주가 상승 기대, 국제유가 환율 하락 확인'}, {'종목코드': '471990', '종목명': 'KODEX AI반도체핵심장비', '거래일자': '2026-04-01', '거래구분': '매수', '거래수량': 81, '거래단가': 24516, '운용사': '신한은행 IRP', '비고': '미국과 이란의 종전 준비 언급으로 주가 상승 기대, 국제유가 환율 하락 확인'}, {'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-04-02', '거래구분': '매수', '거래수량': 24, '거래단가': 82837, '운용사': '신한은행 IRP', '비고': '트럼프의 종전선언 예고로 코스피 급등, 국제유가 환율 급락'}, {'종목코드': '471990', '종목명': 'KODEX AI반도체핵심장비', '거래일자': '2026-04-02', '거래구분': '매수', '거래수량': 40, '거래단가': 24759, '운용사': '신한은행 IRP', '비고': '트럼프의 종전선언 예고로 코스피 급등, 국제유가 환율 급락'}, {'종목코드': '471990', '종목명': 'KODEX AI반도체핵심장비', '거래일자': '2026-04-06', '거래구분': '매수', '거래수량': 25, '거래단가': 23468, '운용사': '신한은행 IRP', '비고': '삼성전자 분기실적 기대 미국 이란 정전선언 기대'}, {'종목코드': '005930', '종목명': '삼성전자', '거래일자': '2026-04-07', '거래구분': '매수', '거래수량': 9, '거래단가': 200000, '운용사': '미래에셋증권', '비고': '삼성전자 분기실적 발표, 미국 이란 휴전 선언으로 국제유가, 환율 급락'}, {'종목코드': '000660', '종목명': 'SK하이닉스', '거래일자': '2026-04-16', '거래구분': '매수', '거래수량': 4, '거래단가': 1154000, '운용사': '미래에셋증권', '비고': '미국의 2차 종전협상 기대에 미국 증시 급등 유가 급락 환율 안정 등 국내주식 시장 전쟁 전으로 회복 분위기'}, {'종목코드': '005930', '종목명': '삼성전자', '거래일자': '2026-04-20', '거래구분': '매수', '거래수량': 24, '거래단가': 216000, '운용사': '미래에셋증권', '비고': '미국 이란 2차 휴전협상 기대감과 전쟁 영향의 피로감에도 불구하고 코스피 안정성 판단'}, {'종목코드': '471990', '종목명': 'KODEX AI반도체핵심장비', '거래일자': '2026-04-21', '거래구분': '매수', '거래수량': 3, '거래단가': 28205, '운용사': '신한은행 IRP', '비고': '코스닥 150 ETF -1% 손실이 지속되어 매도하고 AI반도체핵심장비 매수'}, {'종목코드': '000660', '종목명': 'SK하이닉스', '거래일자': '2026-04-22', '거래구분': '매수', '거래수량': 2, '거래단가': 1223000, '운용사': '미래에셋증권', '비고': 'SK 하이닉스 1분기 성과발표 기대'}, {'종목코드': 278470, '종목명': '에이피알', '거래일자': '2026-04-23', '거래구분': '매수', '거래수량': 10, '거래단가': 444000, '운용사': '미래에셋증권', '비고': 'K뷰티 글로벌 흥행 뉴스, 24년 상장 이후 급성장중인 기업, 시가총액 16.6조'}, {'종목코드': '069500', '종목명': 'KODEX 200', '거래일자': '2026-04-24', '거래구분': '매수', '거래수량': 30, '거래단가': 98218, '운용사': '신한은행 IRP', '비고': '코스피 사상 최고가 경신, 이란 휴전 협상 장기화로 세계경제 혼란으로 주가 불안정 속 저가 매수'}, {'종목코드': '471990', '종목명': 'KODEX AI반도체핵심장비', '거래일자': '2026-04-24', '거래구분': '매수', '거래수량': 171, '거래단가': 29169, '운용사': '신한은행 IRP', '비고': '코스피 사상 최고가 경신, 이란 휴전 협상 장기화로 세계경제 혼란으로 주가 불안정 속 저가 매수'}, {'종목코드': 487240, '종목명': 'KODEX AI전력핵심설비', '거래일자': '2026-04-24', '거래구분': '매수', '거래수량': 111, '거래단가': 44988, '운용사': '신한은행 IRP', '비고': '한국의 전력 핵심시설 관련 기업, 24년 7월 상장이후 308% 급성장'}, {'종목코드': 487240, '종목명': 'KODEX AI전력핵심설비', '거래일자': '2026-04-28', '거래구분': '매수', '거래수량': 103, '거래단가': 49219, '운용사': '신한은행 IRP', '비고': '한국의 전력 핵심시설 관련 기업, 24년 7월 상장이후 308% 급성장'}, {'종목코드': '009150', '종목명': '삼성전기', '거래일자': '2026-04-29', '거래구분': '매수', '거래수량': 5, '거래단가': 820000, '운용사': '미래에셋증권', '비고': '반도체 종목 호황에 힘입어 반도체부품 탄력 기대'}, {'종목코드': '071970', '종목명': 'HD현대마린엔진', '거래일자': '2026-04-29', '거래구분': '매수', '거래수량': 10, '거래단가': 107500, '운용사': '미래에셋증권', '비고': '미국 이란 전쟁 영향 조선업 관심에 부응하여 엔진 생상기업 호황 기대'}, {'종목코드': '', '종목명': '', '거래일자': '', '거래구분': '', '거래수량': '', '거래단가': ' ', '운용사': '', '비고': ''}])
...
목표비중저장파일 = "target_weights_mobile_personal.json"
거래이력자동저장파일 = "trade_history_mobile_personal_autosave.json"
최근업로드거래이력파일 = "trade_history_mobile_personal_latest_uploaded.json"
최근업로드메타파일 = "trade_history_mobile_personal_latest_uploaded_meta.json"
모니터관심종목저장파일 = "monitor_custom_assets_mobile_personal.json"

IRP비주식자산저장파일 = "integrated_non_stock_assets_mobile_personal_v513.json"


def 기본IRP비주식자산표():
    """통합자산관리_업로드_260430.xlsx의 비주식자산 시트를 기본 데이터로 내장합니다."""
    return pd.DataFrame([{'계좌': '신한 IRP', '자산군': 'TDF', '상품명': 'TDF2035', '원금': 50000000, '평가금액': 51873538, '예상연수익률': 3.74, '만기일': '', '반영일자': '2026-04-30', '비고': ''}, {'계좌': '신한 IRP', '자산군': 'TDF', '상품명': 'TDF2045', '원금': 30000000, '평가금액': 31443846, '예상연수익률': 4.81, '만기일': '', '반영일자': '2026-04-30', '비고': ''}, {'계좌': '신한 IRP', '자산군': '정기예금', '상품명': '푸본현대생명 정기예금', '원금': 27499444, '평가금액': 27499444, '예상연수익률': 3.1, '만기일': '2027-02-11', '반영일자': '2026-04-30', '비고': ''}, {'계좌': '신한 IRP', '자산군': '현금성자산', '상품명': '현금성 대기자산', '원금': 5030813, '평가금액': 5030813, '예상연수익률': 2.3, '만기일': '', '반영일자': '2026-04-30', '비고': ''}, {'계좌': '미래에셋', '자산군': '현금성자산', '상품명': '예수금', '원금': 17188280, '평가금액': 17188280, '예상연수익률': 0, '만기일': '', '반영일자': '2026-04-30', '비고': ''}])
...
def 종목별자동코멘트생성(성적표, 거래df=None):
    if 성적표 is None or 성적표.empty:
        return pd.DataFrame(columns=["종목명", "구분", "점수", "판단등급", "자동 코멘트"])
    ...
    for _, 행 in 성적표.iterrows():
        ...
        if 총손익 > 0 and 총수익률 >= 5:
            손익해석 = "수익 구간입니다. 다만 시장 회복, 분할매수 효과, 매도 타이밍 중 무엇이 성과에 기여했는지 분리해서 보는 것이 좋습니다."
        elif 총손익 > 0:
            손익해석 = "소폭 수익 구간입니다. 큰 수익보다 손실을 제한하면서 안정적으로 관리한 결과로 볼 수 있습니다."
        elif 총손익 < 0 and 보유수량 > 0:
            손익해석 = "현재 손실은 평가손실 성격이 포함되어 있습니다. 추가매수보다 비중, 손실 허용 범위, 재진입 기준을 먼저 점검해야 합니다."
        elif 총손익 < 0:
            손익해석 = "누적 손실이 발생했습니다. 진입 가격, 매도 시점, 보유 기간 중 어느 부분에서 손실이 커졌는지 복기할 필요가 있습니다."
        else:
            손익해석 = "손익이 거의 중립입니다. 아직 뚜렷한 강점이나 약점 판단보다 기록 축적이 우선입니다."

        if 구분 == "ETF":
            역할해석 = "ETF는 포트폴리오의 안정축으로 보는 것이 자연스럽습니다. 단기 예측보다 분할 접근과 총투입 한도 관리가 중요합니다."
        elif 구분 == "반도체/대형주":
            역할해석 = "반도체·대형주는 업황, 환율, 미국 기술주 흐름에 민감합니다. 한 번에 크게 진입하기보다 가격 구간을 나누는 방식이 더 안전합니다."
        else:
            역할해석 = "개별주는 종목 고유 이슈에 따른 변동성이 큽니다. 매수 이유와 매도 기준을 거래 메모로 남기면 분석 품질이 좋아집니다."

        if 매도거래수 >= 3:
            if 승률 >= 60:
                매도해석 = f"매도 기준 승률은 {승률:.0f}%로 양호합니다. 다만 승률보다 손익비도 함께 확인해야 합니다."
            elif 승률 < 40:
                매도해석 = f"매도 기준 승률은 {승률:.0f}%로 낮습니다. 진입 기준과 손절 기준을 다시 확인할 필요가 있습니다."
            else:
                매도해석 = f"매도 기준 승률은 {승률:.0f}%로 중간 수준입니다. 수익 거래와 손실 거래의 보유기간 차이를 비교해 볼 필요가 있습니다."
        else:
            매도해석 = "매도 사례가 많지 않아 승률 평가는 참고 수준입니다. 현재는 매수 가격대와 보유 비중 관리가 더 중요합니다."

        다음점검 = []
        if 패턴.get("매수횟수", 0) >= 2 and 총손익 < 0:
            다음점검.append("추가매수 전 최대 손실 한도와 2차·3차 매수 기준을 먼저 정하세요")
        elif 패턴.get("매수횟수", 0) >= 2 and 총손익 > 0:
            다음점검.append("분할매수가 효과를 낸 구간인지 확인하고, 같은 기준을 반복 적용할 수 있는지 점검하세요")
        if 실현손익 > 0 and 평가손익 < 0:
            다음점검.append("확정 수익은 있으나 보유분 손실이 있어 최근 흐름을 따로 점검하세요")
        elif 실현손익 < 0 and 평가손익 > 0:
            다음점검.append("과거 손실 후 보유분이 회복 중이므로 성급한 매도보다 기준가를 정해 관찰하세요")
        if not 다음점검:
            다음점검.append("다음 거래부터 매수 이유, 목표가, 손절 기준을 함께 기록하세요")
        ...
        자동코멘트 = " ".join([
            ...
            패턴["거래메모"],
            "다음 점검: " + " / ".join(다음점검) + ".",
            "이 내용은 매수·매도 지시가 아니라 거래기록 기반 참고 의견입니다."
        ])
...
def 자동분석코멘트UI(성적표, 거래df=None):
    with st.expander("v5.10.3b 거래기록 기반 코멘트", expanded=True):
        st.caption("기존 화면 구성은 유지하고, 코멘트만 거래기록·매수패턴·보유/매도 습관 중심으로 고도화했습니다.")
        ...
        st.markdown("#### 종목별 핵심 코멘트")
        보기열 = ["종목명", "구분", "점수", "판단등급", "총손익", "총수익률", "승률", "매수패턴", "손익해석", "다음점검"]
        표시 = 코멘트표[보기열].copy()
        표데이터프레임(
        ...
        with st.expander("문장형 상세 코멘트", expanded=False):
            상세표 = 코멘트표[["종목명", "판단등급", "자동 코멘트"]].copy()
            표데이터프레임(index_1부터(상세표), use_container_width=True)

        with st.expander("코멘트와 AI 분석의 차이", expanded=False):
            차이표 = pd.DataFrame([
                {"구분": "자동 코멘트", "의미": "앱 내부 규칙과 거래기록 계산값으로 생성", "장점": "일관성·재현성·빠른 계산", "한계": "뉴스·공시·거시경제 해석은 제한"},
                {"구분": "AI 분석", "의미": "거래기록, 차트, 시장변수, 사용자의 투자 의도까지 종합해 설명", "장점": "문맥 해석과 원인 추정이 풍부", "한계": "근거 데이터가 부족하면 추정이 섞일 수 있음"},
            ])
...
def 대시보드스타일적용():
    ...
    .flow-panel-title {{font-size: 1.02rem; font-weight: 850; color: #f8fafc; margin-bottom: 2px;}}
    ...
    .flow-name {{font-size: 0.86rem; font-weight: 750; color: #cbd5e1;}}
    ...
    .flow-value {{font-size: 0.84rem; font-weight: 850; text-align: right; font-variant-numeric: tabular-nums;}}
...
if 섹터선택키 not in st.session_state or st.session_state.get(섹터선택키) not in 섹터목록:
    st.session_state[섹터선택키] = "포트폴리오 현황" if 모바일여부() else "주요 모니터링"
