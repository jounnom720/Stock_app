...
기본포트폴리오 = pd.DataFrame([
    {"종목코드": "069500", "종목명": "KODEX 200", "거래일자": "2026-03-05", "거래구분": "매수", "거래수량": 10, "거래단가": 33500, "운용사": "샘플계좌", "비고": "샘플 데이터"},
    {"종목코드": "005930", "종목명": "삼성전자", "거래일자": "2026-03-07", "거래구분": "매수", "거래수량": 15, "거래단가": 61200, "운용사": "샘플계좌", "비고": "샘플 데이터"},
    {"종목코드": "229200", "종목명": "KODEX 코스닥150", "거래일자": "2026-03-10", "거래구분": "매수", "거래수량": 8, "거래단가": 14980, "운용사": "샘플계좌", "비고": "샘플 데이터"},
    {"종목코드": "069500", "종목명": "KODEX 200", "거래일자": "2026-03-18", "거래구분": "매수", "거래수량": 5, "거래단가": 34120, "운용사": "샘플계좌", "비고": "추가매수 예시"},
    {"종목코드": "005930", "종목명": "삼성전자", "거래일자": "2026-03-21", "거래구분": "매도", "거래수량": 3, "거래단가": 62800, "운용사": "샘플계좌", "비고": "부분매도 예시"},
])
...
st.caption("현재 Share 버전은 샘플 거래이력으로 시작하며, 직접 입력하거나 업로드한 거래이력으로 아래 모든 표와 분석이 자동 연동됩니다.")
st.caption(
